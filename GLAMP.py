...
layers = networks.build_GLAMP(prob,T=T,shrink=shrink,untied=False)
...
sess = train.do_training(training_stages,prob,'GLAMP_bg_giid.npz',10,10,50)
...
train.evaluate_nmse(sess, training_stages, prob, 'GLAMP_bg_giid.npz',SNR=SNR, L=L)
