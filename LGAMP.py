...
layers = networks.build_LGAMP(prob,T=2,shrink='onebitF',untied=True,tf_floattype = tf.float32)
...
sess = train.do_training(training_stages,prob,'LGAMP_bg_giid.npz',10,3000,50)
